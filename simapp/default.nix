    ...
    packages = {
      ...
      pkgs.buildGoApplication rec {
        ...
        postFixup = lib.optionalString pkgs.stdenv.isDarwin ''
          ${pkgs.stdenv.cc.targetPrefix}install_name_tool -change "@rpath/librocksdb.8.dylib" "${inputs.rocksdb}/lib/librocksdb.dylib" $out/bin/${pname}
        '';
        ...
        meta = with lib; {
          ...
          mainProgram = pname + pkgs.stdenv.hostPlatform.extensions.executable;
